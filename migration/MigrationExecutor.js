                    ...
                    case 7:
                        ...
                        _loop_2 = function (migration) {
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        if (!(this_2.transaction === "each" && (migration.instance == null || migration.instance.transaction !== false) && !queryRunner.isTransactionActive)) return [3 /*break*/, 2];
                                        return [4 /*yield*/, queryRunner.startTransaction()];
                                    case 1:
                                        _a.sent();
                                        transactionStartedByUs = true;
                                    ...
                                    case 2: return [4 /*yield*/, migration.instance.up(queryRunner)
                                            ...
                                            return tslib_1.__generator(this, function (_a) {
                                                switch (_a.label) {
                                                    ...
                                                    case 1:
                                                        _a.sent();
                                                        if (!(this.transaction === "each" && (migration.instance == null || migration.instance.transaction !== false) && transactionStartedByUs)) return [3 /*break*/, 3];
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        transactionStartedByUs = false;
                        if (!((this.transaction !== "none") && (migrationToRevert.instance == null || migrationToRevert.instance.transaction !== false) && !queryRunner.isTransactionActive)) return [3 /*break*/, 4];
                        return [4 /*yield*/, queryRunner.startTransaction()];
                    case 3:
                        _a.sent();
                        transactionStartedByUs = true;
