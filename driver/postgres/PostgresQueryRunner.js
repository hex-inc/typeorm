...
var PostgresQueryRunner = /** @class */ (function (_super) {
    ...
    PostgresQueryRunner.prototype.setGetMetadata = function (getMetadata) {
        ...
        if (this.mode === "slave" && this.driver.isReplicated) {
            this.databaseConnectionPromise = this.driver.obtainSlaveConnection().then(function (_a) {
                ...
                _this.releaseCallback = function () {
                    ...
                    release();
                    var index = _this.driver.connectedQueryRunners.indexOf(_this);
                    if (index !== -1)
                        _this.driver.connectedQueryRunners.splice(index);
                };
     ...
     */
    PostgresQueryRunner.prototype.query = function (rawQuery, parameters) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var query, metadata, serializedMetadata, sanitizedSerializedMetadata, databaseConnection, queryStartTime, result, maxQueryExecutionTime, queryEndTime, queryExecutionTime, err_1;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (this.isReleased)
                        ...
                        if (this.getMetadata != null) {
                            ...
                            if (metadata != null && Object.keys(metadata).length > 0) {
                                serializedMetadata = Object.entries(metadata).map(function (_a) {
                                    var _b = tslib_1.__read(_a, 2), key = _b[0], value = _b[1];
                                    return key + "='" + value + "'";
                                }).join(",");
                                sanitizedSerializedMetadata = serializedMetadata.replace(/\*\//g, "");
