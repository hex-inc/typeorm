...
var PostgresQueryRunner = /** @class */ (function (_super) {
    ...
    PostgresQueryRunner.prototype.setMetadata = function (metadata) {
    ...
    PostgresQueryRunner.prototype.query = function (rawQuery, parameters) {
        return __awaiter(this, void 0, void 0, function () {
            var query, serializedMetadata, sanitizedSerializedMetadata, databaseConnection, queryStartTime, result, maxQueryExecutionTime, queryEndTime, queryExecutionTime, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (this.isReleased)
                        ...
                        if (this.metadata != null) {
                            serializedMetadata = Object.entries(this.metadata).map(function (_a) {
