...
declare type CustomRepositoryWrapper = (repositoryClass: any, repositoryInstance: any) => any;
export declare function setCustomRepositoryWrapper(wrapper: CustomRepositoryWrapper): void;
/**
